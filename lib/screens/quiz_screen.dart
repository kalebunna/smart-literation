...
class _QuizScreenState extends State<QuizScreen> {
  ...
  Future<void> _loadQuestions() async {
    ...
    try {
      ...
      // await Provider.of<QuizProvider>(context, listen: false).getQuestionsByMaterialId(widget.materialId);
  ...
  void _nextQuestion() {
    if (_currentQuestionIndex < _questions.length - 1) {
      ...
      // Quiz selesai, navigasi ke halaman summary
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Quiz ${material?.title ?? ''}'),
