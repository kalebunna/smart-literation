...
#ifndef SMART_LITERATION_V1_SWIFT_H
#define SMART_LITERATION_V1_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="smart_literation_v1",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC19smart_literation_v111AppDelegate")
...
SWIFT_CLASS("_TtC19smart_literation_v117MainFlutterWindow")
